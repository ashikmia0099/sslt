    ...
    return (
        ...
        <div className='bg-white'>
                    ...
                    <div className=" mt-10 pb-20  mx-auto">
                        ...
                        >
                            <SwiperSlide className=' rounded-2xl  bg-gradient-to-r from-[#8f8ee9] to-[#84C2DB] '>
                                <Image src={banner1} alt="Slide 1" className=" h-[400px]  lg:h-[650px] w-full rounded-xl " />
                            </SwiperSlide>

                            <SwiperSlide className='bg-gradient-to-r from-[#8f8ee9] to-[#84dbcd] rounded-2xl '>
                                <Image src={banner2} alt="Slide 2" className="h-[400px] lg:h-[650px] w-full rounded-xl " />
                            </SwiperSlide>

                            <SwiperSlide className='bg-gradient-to-r from-[#3e3d9e] to-[#9784db] rounded-2xl '>
                                <Image src={banner3} alt="Slide 3" className="h-[400px] lg:h-[650px] w-full rounded-xl " />
                            </SwiperSlide>
                            <SwiperSlide className='bg-gradient-to-r from-[#abe98e] to-[#880bdb] rounded-2xl '>
                                <Image src={banner4} alt="Slide 3" className="h-[400px] lg:h-[650px] w-full rounded-xl " />
                            </SwiperSlide>
            ...
            <div className='relative '>
                ...
                {/* grid secion 3 */}
                <div className=' pt-5 lg:pt-24 max-w-[1536px] mx-auto px-5 pb-10 md:pb-0'>
                    <div className=' grid lg:grid-cols-2 gap-0 lg:gap-32'>
                        {/* text part */}
