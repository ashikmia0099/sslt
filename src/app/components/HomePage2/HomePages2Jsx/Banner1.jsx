...
function Banner1() {
  ...
  return (
    <div className='max-w-[1536px] mx-auto pt-16'>
      <div className='grid lg:grid-cols-2 h-full  items-center justify-center -mt-5 lg:-mt-10  '>

        {/* Text Section */}
        <div>
          <h1 className={` text-3xl md:text-4xl lg:text-6xl xl:text-8xl font-extrabold uppercase leading-8 md:leading:10 lg:leading-16 xl:leading-28 goudy-bookletter-1911-regular text-center lg:text-left px-5 `}>
            <span className='text-[#84C2DB]'>Society of Speech &</span> <AuroraText> Language Therapists</AuroraText>
          </h1>


          <p className={` text-[16px] md:text-lg lg:text-lg xl:text-2xl px-5 font-bold mt-10 text-center lg:text-left pb-8 lg:pb-0 ${montserrat.className}`}>
          ...
          <div className=' hidden lg:block px-0 lg:px-5 '>
