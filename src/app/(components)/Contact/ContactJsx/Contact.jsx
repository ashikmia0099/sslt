    ...
    return (
        <div className='max-w-[1596px] mx-auto bg-white'>
            <div >
                ...
                <h1 className={` text-3xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold uppercase leading-10 md:leading-14 lg:leading-20 xl:leading-28 text-center px-5 md:px-[10%] xl:px-[20%] pt-16`}>
            ...
            <div className=' grid md:grid-cols-2 gap-y-10 xl:gap-y-22 gap-0 md:gap-10 xl:gap-20 px-5 xl:px-36 pb-16 xl:pb-36 pt-10 lg:pt-20'>
                ...
                <div className='px-5 xl:px-10 py-6 rounded-2xl shadow-xl shadow-[#91aab4] '>
                    ...
                    <p className=' text-[16px] lg:text-lg font-semibold leading-6 pt-3'>amet consectetur adipisicing elit. Quam odit nam laudantium officiis corporis earum suscipit </p>
