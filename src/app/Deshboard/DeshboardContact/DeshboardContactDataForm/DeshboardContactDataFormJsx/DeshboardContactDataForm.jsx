...
function DeshboardContactDataForm() {
    ...
    return (
        <div className='m-10 px-10 py-10 border border-[#9EFF00] rounded-2xl'>
            <h1 className='text-4xl font-semibold uppercase text-center border-b pb-6 text-white'>Post Contect Data Form</h1>
...
export default DeshboardContactDataForm