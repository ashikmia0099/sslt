...
function NewStudentMambership() {
  return (
     <div>
          <div className=' pt-10'>
            <h1 className=' text-4xl font-semibold text-white text-center py-14'>New Student Membership</h1>
...
export default NewStudentMambership