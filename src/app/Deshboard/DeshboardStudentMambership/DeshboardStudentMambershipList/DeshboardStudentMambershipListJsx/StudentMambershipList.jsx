...
function StudentMambershipList() {
  return (
    <div>
      <div className=' pt-10'>
        <h1 className=' text-4xl font-semibold text-white text-center py-14'>All Student Membership</h1>
...
export default StudentMambershipList